                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if ($allUser->id_jabatan != '1') { ?>
                                                ...
                                                <a href="<?= base_url('admin/ubah_pengguna/') . $allUser->id_user ?>" class="text-warning" data-toggle="tooltip" data-placement="top" title="Ubah Data"><i class="fas fa-edit fa-fw"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
