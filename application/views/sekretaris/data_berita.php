    ...
    <div class="row">
        <div class="col-md">
            <div class="card ">
                ...
                <div class="card-body ">
                    <a href="<?= base_url('sekretaris/tambah_berita') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Berita</a>
                        ...
                        <tbody>
                            ...
                            foreach ($allBerita as $allBerita) { ?>
                                <tr>
                                    ...
                                    <td><?= date('d F Y H:i:s', strtotime($allBerita->publish_at)) ?></td>
                                    <td style="min-width: 100px;" class="text-center">
                                        <a href="<?= base_url('sekretaris/ubah_berita/') . $allBerita->id_berita ?>" class="text-warning" data-toggle="tooltip" data-placement="top" title="Ubah Berita"><i class="fas fa-edit fa-fw"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
